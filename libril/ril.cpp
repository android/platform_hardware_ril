...
extern "C"
char hidl_service_name_base[MAX_SERVICE_NAME_LENGTH] = HIDL_SERVICE_NAME_BASE;
extern "C"
char hidl_service_name[MAX_SERVICE_NAME_LENGTH] = HIDL1_SERVICE_NAME;
/*******************************************************************/
...
char * RIL_getServiceName() {
    return hidl_service_name;
}

extern "C"
void RIL_setServiceName(const char * s) {
    strncpy(hidl_service_name, s, MAX_SERVICE_NAME_LENGTH);
}
