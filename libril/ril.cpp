...
static int responseSsn(Parcel &p, int slotId, int requestNumber, int responseType, int token,
        RIL_Errno e, void *response, size_t responselen);
static int responseSimStatus(Parcel &p, int slotId, int requestNumber, int responseType, int token,
        RIL_Errno e, void *response, size_t responselen);
...
static int responseSimStatus(Parcel &p, int slotId, int requestNumber, int responseType, int token,
    ...
    radio::iccCardStatusResponse(slotId, responseType, token, e, response, responselen);
...
#endif
{
    ...
    if (unsolResponse != RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED) {
        ...
        radio::radioStateChanged(soc_id, newState);
    }
