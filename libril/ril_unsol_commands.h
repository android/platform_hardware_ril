...
*/
    ...
    {RIL_UNSOL_RESERVED_DUMMY, responseInts, WAKE_PARTIAL}
#ifdef VIDEO_TELEPHONY_ENABLE
    ,{RIL_UNSOL_RESPONSE_VT_CALL_EVENT_CALL_CONF, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_PROGRESS_INFO_IND, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_CONNECT, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_SETUP_IND, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_INCOM, responseRaw, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_END, responseInts, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_MODIFY_IND, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_MODIFY_REQ, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_MODIFY_COMPLETE_CONF, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_MODIFY_RES, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_RESPONSE_VT_CALL_EVENT_UNKNOWN, responseVoid, WAKE_PARTIAL}
