...
struct RadioImpl : public ::android::hardware::radio::V1_1::IRadio {
    ...
    Return<void> setResponseFunctions(
            const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& radioResponse,
            const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& radioIndication);
...
Return<void> RadioImpl::setResponseFunctions(
        const ::android::sp<::android::hardware::radio::V1_0::IRadioResponse>& radioResponseParam,
        const ::android::sp<::android::hardware::radio::V1_0::IRadioIndication>& radioIndicationParam) {
...
int radio::setCarrierInfoForImsiEncryptionResponse(int slotId,
    ...
    if (radioService[slotId]->mRadioResponse != NULL) {
        RadioResponseInfo responseInfo = {};
        populateResponseInfo(responseInfo, serial, responseType, e);
        ::android::hardware::radio::V1_1::IRadioResponse *radioResponseV1_1 =
                (::android::hardware::radio::V1_1::IRadioResponse *)
                radioService[slotId]->mRadioResponse.get();
        Return<void> retStatus
...
int radio::carrierInfoForImsiEncryption(int slotId,
    ...
    if (radioService[slotId] != NULL && radioService[slotId]->mRadioIndication != NULL) {
        ...
        ::android::hardware::radio::V1_1::IRadioIndication *radioIndicationV1_1 =
                (::android::hardware::radio::V1_1::IRadioIndication *)
                radioService[slotId]->mRadioIndication.get();
        Return<void> retStatus = radioIndicationV1_1->
