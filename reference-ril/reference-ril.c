...
static void onUnsolicited (const char *s, const char *sms_pdu)
{
    ...
    if (strStartsWith(s, "%CTZV:")) {
        ...
        LOGE("STK Command ID : %d \n", nSTKCmd);
        /*
         * TBD: To make the case labels more meaningful and more orderly,
         * instead of plain numbers.
         * Reference TS for following payloads : ETSI TS 102 223 & TS 102 384
        */
        switch (nSTKCmd) {
            case 1:
               //SETUP MENU 27.22.4.8.1  seq 1.1.1
               response = strdup("D03B810301250082028182850C546F6F6C6B6974204D656E758F07014974656D20318F07024974656D20328F07034974656D20338F07044974656D2034");
               break;
            case 2:
               //NULL SETUP MENU
               response = strdup("D00D81030125008202818285008F00");
               break;
            case 3:
            ...
            case 6:
                ...
                break;
            case 7:
                //SET UP IDLE MODE TEXT 2.2.1A - Icon support example
