...
extern char hidl_service_name_base[MAX_SERVICE_NAME_LENGTH];
extern char hidl_service_name[MAX_SERVICE_NAME_LENGTH];
...
int main(int argc, char **argv) {
    ...
    if (strncmp(clientId, "0", MAX_CLIENT_ID_LENGTH)) {
        strncpy(hidl_service_name, hidl_service_name_base, MAX_SERVICE_NAME_LENGTH);
        strncat(hidl_service_name, clientId, MAX_SERVICE_NAME_LENGTH);
        RIL_setServiceName(hidl_service_name);
    }
