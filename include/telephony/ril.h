...
typedef enum {
    ...
    RIL_E_ILLEGAL_SIM_OR_ME = 15,               /* network selection failed due to
                                                   illegal SIM or ME */
    RIL_E_DIAL_MODIFIED_TO_USSD = 16,           /* DIAL request modified to USSD */
    RIL_E_DIAL_MODIFIED_TO_SS = 17,             /* DIAL request modified to SS */
    RIL_E_DIAL_MODIFIED_TO_DIAL = 18,           /* DIAL request modified to DIAL with different data */
    RIL_E_USSD_MODIFIED_TO_DIAL = 19,           /* USSD request modified to DIAL */
    RIL_E_USSD_MODIFIED_TO_SS = 20,             /* USSD request modified to SS */
    RIL_E_USSD_MODIFIED_TO_USSD = 21,           /* USSD request modified to different USSD request */
    RIL_E_SS_MODIFIED_TO_DIAL = 22,             /* SS request modified to DIAL */
    RIL_E_SS_MODIFIED_TO_USSD = 23,             /* SS request modified to USSD */
    RIL_E_SS_MODIFIED_TO_SS = 24                /* SS request modified to different SS request */
} RIL_Errno;
...
typedef struct {
  int validIndexes; /* This gives the number of valid values in cfInfo.
                       For example if voice is forwarded to one number and data
                       is forwarded to a different one then validIndexes will be
                       2 indicating total number of valid values in cfInfo.
                       Similarly if all the services are forwarded to the same
                       number then the value of validIndexes will be 1. */
 ...
 * call control.
 * STK CC feature refers to spec 3GPP TS 31.111, section 7.3.
 *
 * "data" is const RIL_StkCcUnsolSsResponse *
 *
 */
#define RIL_UNSOL_ON_SS 1031

/**
 * RIL_UNSOL_CARD_CC_ALPHA_NOTIFY
 *
 ...
 *
 */
#define RIL_UNSOL_CARD_CC_ALPHA_NOTIFY 1032
