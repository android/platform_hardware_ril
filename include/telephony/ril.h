...
typedef struct {
    ...
    int cqi;             /* The current Channel Quality Indicator.
                          ...
                          * INT_MAX : 0x7FFFFFFF denotes invalid value.
                          * Reference: 3GPP TS 36.101 9.2, 9.3, A.4 */
    int timingAdvance;   /* TBD on what the representation is to be */
} RIL_LTE_SignalStrength_v7;
...
typedef struct {
    ...
    RIL_CDMA_SignalStrength     CDMA_SignalStrength;
    RIL_EVDO_SignalStrength     EVDO_SignalStrength;
    RIL_LTE_SignalStrength_v7   LTE_SignalStrength;
} RIL_SignalStrength_ver7;
...
typedef enum {
  RIL_CELL_INFO_TYPE_GSM	= 0,
  RIL_CELL_INFO_TYPE_CDMA	= 1,
  RIL_CELL_INFO_TYPE_LTE	= 2,
} RIL_CellInfoType;
...
typedef struct {
  ...
  long              time;           /* Time in nanos as returned by elapsedRealtimeNano */
  union {
    RIL_CellInfoGsm     gsm;
 ...
 */
#define RIL_REQUEST_GET_CELL_INFO 109

/**
 * RIL_REQUEST_SET_UNSOL_CELL_INFO_RATE
 *
 * Sets the minimum time between when RIL_UNSOL_CELL_INFO should be invoked.
 * The default, 0, means invoke RIL_UNSOL_CELL_INFO when any of the reported information
 * changes. Setting the value to MAX_INT(0x7fffffff) means never issue a
 * RIL_UNSOL_CELL_INFO.
 *
 * "data" is int *
 ...
 *  GENERIC_FAILURE
 */
#define RIL_REQUEST_SET_UNSOL_CELL_INFO_RATE 112
 ...
 * RIL_UNSOL_CELL_INFO
 *
 * Same information as returned by RIL_REQUES_GET_CELL_INFO, but returned
 ...
 * "response" is an array of RIL_CellInfo.
 */
#define RIL_UNSOL_CELL_INFO 1036
