...
typedef enum {
    ...
    PDP_FAIL_PREF_RADIO_TECH_CHANGED = -3, /* current/preferred technology has changed or
                                              change in progress, retry with parameters
 ...
 *                        one of the values of RIL_DataCallFailCause. If the call succeeded, must
 *                        be 0. The call can also succeed with partial failure, as is the case
 *                        with failure causes 0x32, 0x33 and 0x34.
 *
