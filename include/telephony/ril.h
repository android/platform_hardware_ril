...
typedef enum {
    ...
    RIL_DC_POWER_STATE_RADIO_OFF          = 1,    // Radio off
    RIL_DC_POWER_STATE_DORMANT            = 2,    // Radio is in a low power state
    RIL_DC_POWER_STATE_NOT_DORMANT        = 3,    // Radio is in a high power state
} RIL_DcPowerStates;
 ...
 * "data" is NULL
 *
 * "response" is an array of the last set of RIL_DcRtInfo's
 *
 * Valid errors:
 *  SUCCESS
 *  RADIO_NOT_AVAILABLE
 ...
 */
#define RIL_REQUEST_GET_DC_RT_INFO 109
 ...
 */
#define RIL_REQUEST_SET_DC_RT_INFO_RATE 110
 ...
 *
 * "data" is an array of the last set of RIL_DcRtInfo's
 *
 */
#define RIL_UNSOL_DC_RT_INFO_CHANGED 1036
