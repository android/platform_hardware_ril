...
/* Deprecated, use RIL_CardStatus_v5 */
typedef struct
{
...
typedef struct
{
  ...
  int           gsm_umts_subscription_app_index; /* value < RIL_CARD_MAX_APPS */
  int           cdma_subscription_app_index;     /* value < RIL_CARD_MAX_APPS */
  int           ims_subscription_app_index;      /* value < RIL_CARD_MAX_APPS */
  int           num_applications;                /* value <= RIL_CARD_MAX_APPS */
  RIL_AppStatus applications[RIL_CARD_MAX_APPS];
} RIL_CardStatus_v5;
...
/* Deprecated, use RIL_SignalStrength_v5 */
typedef struct {
    RIL_GW_SignalStrength   GW_SignalStrength;
    RIL_CDMA_SignalStrength CDMA_SignalStrength;
    RIL_EVDO_SignalStrength EVDO_SignalStrength;
} RIL_SignalStrength_v4;
 ...
 * field in RIL_Data_Call_Response_v5.
 *
 ...
 *
 * Deprecated use the status field in RIL_Data_Call_Response_v5.
 */
 ...
 */
#define RIL_REQUEST_CDMA_GET_SUBSCRIPTION 104
 ...
 *
 * Called when the data network state changed
 *
 * Callee will invoke the following requests on main thread:
 *
 * RIL_REQUEST_DATA_REGISTRATION_STATE
 ...
 * "data" is NULL
 */
#define RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED 1034
