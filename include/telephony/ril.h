 ...
 *                    New commands added: RIL_REQUEST_SET_DEVICE_STATE,
 ...
 * screen is on.
 *
 * Note this request is deprecated. Use RIL_REQUEST_SET_DEVICE_STATE to report the device state
 ...
 *  RADIO_NOT_AVAILABLE (radio resetting)
 */
#define RIL_REQUEST_SET_DEVICE_STATE 138
