...
typedef enum {
    ...
    PDP_FAIL_COLLISION_WITH_NW_INIT_REQ = 0x38,
    ...
    PDP_FAIL_INVALID_PCSCF_DNS_ADDR = 0x7C,
    PDP_FAIL_CALL_PREEMPT_BY_EMERGENCY_APN = 0x7F,
    PDP_FAIL_UE_INIT_DETACH_OR_DISCONNECT = 0x80,
    ...
    PDP_FAIL_MIP_FA_MOBILE_NODE_AUTH_FAILURE = 0x7D3,
    PDP_FAIL_MIP_FA_HA_AUTH_FAILURE = 0x7D4,
    PDP_FAIL_MIP_FA_REQ_LIFETIME_TOO_LONG = 0x7D5,
    ...
    PDP_FAIL_MIP_FA_VJHC_UNAVAILABLE = 0x7D9,
    PDP_FAIL_MIP_FA_REV_TUNNEL_UNAVAILABLE = 0x7DA,
    PDP_FAIL_MIP_FA_REV_TUNNEL_IS_MAND_AND_T_BIT_NOT_SET = 0x7DB,
    PDP_FAIL_MIP_FA_DELIVERY_STYLE_NOT_SUPP = 0x7DC,
    PDP_FAIL_MIP_FA_MISSING_NAI = 0x7DD,
    PDP_FAIL_MIP_FA_MISSING_HA = 0x7DE,
    PDP_FAIL_MIP_FA_MISSING_HOME_ADDR = 0x7DF,
    ...
    PDP_FAIL_MIP_HA_MOBILE_NODE_AUTH_FAILURE = 0x7E6,
    PDP_FAIL_MIP_HA_FA_AUTH_FAILURE = 0x7E7,
    PDP_FAIL_MIP_HA_REGISTRATION_ID_MISMATCH = 0x7E8,
    PDP_FAIL_MIP_HA_MALFORMED_REQUEST = 0x7E9,
    PDP_FAIL_MIP_HA_UNKNOWN_HA_ADDR = 0x7EA,
    PDP_FAIL_MIP_HA_REV_TUNNEL_UNAVAILABLE = 0x7EB,
    PDP_FAIL_MIP_HA_REV_TUNNEL_IS_MANDATORY_AND_T_BIT_NOT_SET = 0x7EC,
    PDP_FAIL_MIP_HA_ENCAPSULATION_UNAVAILABLE = 0x7ED,
    PDP_FAIL_CLOSE_IN_PROGRESS = 0x7EE,
    PDP_FAIL_NW_INITIATED_TERMINATION = 0x7EF,
    PDP_FAIL_MODEM_APP_PREEMPTED = 0x7F0,
    PDP_FAIL_ERR_PDN_IPV4_CALL_DISALLOWED = 0x7F1,
    PDP_FAIL_ERR_PDN_IPV4_CALL_THROTTLED = 0x7F2,
    PDP_FAIL_ERR_PDN_IPV6_CALL_DISALLOWED = 0x7F3,
    PDP_FAIL_ERR_PDN_IPV6_CALL_THROTTLED = 0x7F4,
    PDP_FAIL_MODEM_RESTART = 0x7F5,
    PDP_FAIL_PDP_PPP_NOT_SUPPORTED = 0x7F6,
    PDP_FAIL_UNPREFERRED_RAT = 0x7F7,
    PDP_FAIL_PHYS_LINK_CLOSE_IN_PROGRESS = 0x7F8,
    PDP_FAIL_APN_PENDING_HANDOVER = 0x7F9,
    PDP_FAIL_PROFILE_BEARER_INCOMPATIBLE = 0x7FA,
    PDP_FAIL_SIM_CARD_EVT = 0x7FB,
    PDP_FAIL_LPM_OR_PWR_DOWN = 0x7FC,
    PDP_FAIL_APN_DISABLED = 0x7FD,
    PDP_FAIL_MAX_PPP_INACTIVITY_TIMER_EXPIRED = 0x7FE,
    PDP_FAIL_IPV6_ADDR_TRANSFER_FAILED = 0x7FF,
    ...
    PDP_FAIL_MAX_V4_CONNECTIONS = 0x804,
    PDP_FAIL_MAX_V6_CONNECTIONS = 0x805,
    ...
    PDP_FAIL_IFACE_IN_USE = 0x80A,
    PDP_FAIL_APN_DISALLOWED_ON_ROAMING = 0x80C,
    PDP_FAIL_APN_PARAM_CHANGED = 0x80D,
    PDP_FAIL_NULL_APN_DISALLOWED = 0x80E,
    PDP_FAIL_THERMAL_MITIGATION = 0x80F,
    PDP_FAIL_DATA_SETTINGS_DISABLED = 0x810,
    PDP_FAIL_DATA_ROAMING_SETTINGS_DISABLED = 0x811,
    PDP_FAIL_DDS_CALL_ABORT = 0x812,
    PDP_FAIL_INVALID_APN_NAME = 0x813,
    PDP_FAIL_DDS_SWITCH_IN_PROGRESS = 0x814,
    PDP_FAIL_CALL_DISALLOWED_IN_ROAMING = 0x815,
    PDP_FAIL_NON_IP_NOT_SUPPORTED = 0x816,
    PDP_FAIL_ERR_PDN_NON_IP_CALL_THROTTLED = 0x817,
    PDP_FAIL_ERR_PDN_NON_IP_CALL_DISALLOWED = 0x818,
    PDP_FAIL_CDMA_LOCK = 0x819,
    PDP_FAIL_CDMA_INTERCEPT = 0x81A,
    PDP_FAIL_CDMA_REORDER = 0x81B,
    PDP_FAIL_CDMA_REL_SO_REJ = 0x81C,
    PDP_FAIL_CDMA_INCOM_CALL = 0x81D,
    PDP_FAIL_CDMA_ALERT_STOP = 0x81E,
    PDP_FAIL_CHANNEL_ACQUISITION_FAILURE = 0x81F,
    PDP_FAIL_MAX_ACCESS_PROBE = 0x820,
    PDP_FAIL_CCS_NOT_SUPPORTED_BY_BS = 0x821,
    PDP_FAIL_NO_RESPONSE_FROM_BS = 0x822,
    PDP_FAIL_REJECTED_BY_BS = 0x823,
    PDP_FAIL_CCS_INCOMPATIBLE = 0x824,
    PDP_FAIL_NO_CDMA_SRV = 0x825,
    PDP_FAIL_UIM_NOT_PRESENT = 0x826,
    PDP_FAIL_CDMA_RETRY_ORDER = 0x827,
    PDP_FAIL_ACCESS_BLOCK = 0x828,
    PDP_FAIL_ACCESS_BLOCK_ALL = 0x829,
    PDP_FAIL_IS707B_MAX_ACC = 0x82A,
    PDP_FAIL_THERMAL_EMERGENCY = 0x82B,
    PDP_FAIL_CCS_NOT_ALLOWED = 0x82C,
    PDP_FAIL_INCOM_REJ = 0x82D,
    PDP_FAIL_NO_GATEWAY_SRV = 0x82E,
    PDP_FAIL_NO_GPRS_CONTEXT = 0x82F,
    PDP_FAIL_ILLEGAL_MS = 0x830,
    PDP_FAIL_ILLEGAL_ME = 0x831,
    PDP_FAIL_GPRS_SERVICES_AND_NON_GPRS_SERVICES_NOT_ALLOWED = 0x832,
    PDP_FAIL_GPRS_SERVICES_NOT_ALLOWED = 0x833,
    PDP_FAIL_MS_IDENTITY_CANNOT_BE_DERIVED_BY_THE_NETWORK = 0x834,
    PDP_FAIL_IMPLICITLY_DETACHED = 0x835,
    PDP_FAIL_PLMN_NOT_ALLOWED = 0x836,
    PDP_FAIL_LA_NOT_ALLOWED = 0x837,
    PDP_FAIL_GPRS_SERVICES_NOT_ALLOWED_IN_THIS_PLMN = 0x838,
    PDP_FAIL_PDP_DUPLICATE = 0x839,
    PDP_FAIL_UE_RAT_CHANGE = 0x83A,
    PDP_FAIL_CONGESTION = 0x83B,
    PDP_FAIL_NO_PDP_CONTEXT_ACTIVATED = 0x83C,
    PDP_FAIL_ACCESS_CLASS_DSAC_REJECTION = 0x83D,
    PDP_FAIL_PDP_ACTIVATE_MAX_RETRY_FAILED = 0x83E,
    PDP_FAIL_RAB_FAILURE = 0x83F,
    PDP_FAIL_ESM_UNKNOWN_EPS_BEARER_CONTEXT = 0x840,
    PDP_FAIL_DRB_RELEASED_AT_RRC = 0x841,
    PDP_FAIL_NAS_SIG_CONN_RELEASED = 0x842,
    PDP_FAIL_EMM_DETACHED = 0x843,
    PDP_FAIL_EMM_ATTACH_FAILED = 0x844,
    PDP_FAIL_EMM_ATTACH_STARTED = 0x845,
    PDP_FAIL_LTE_NAS_SERVICE_REQ_FAILED = 0x846,
    PDP_FAIL_ESM_ACTIVE_DEDICATED_BEARER_REACTIVATED_BY_NW = 0x847,
    PDP_FAIL_ESM_LOWER_LAYER_FAILURE = 0x848,
    PDP_FAIL_ESM_SYNC_UP_WITH_NW = 0x849,
    PDP_FAIL_ESM_NW_ACTIVATED_DED_BEARER_WITH_ID_OF_DEF_BEARER = 0x84A,
    PDP_FAIL_ESM_BAD_OTA_MESSAGE = 0x84B,
    PDP_FAIL_ESM_DS_REJECTED_THE_CALL = 0x84C,
    PDP_FAIL_ESM_CONTEXT_TRANSFERED_DUE_TO_IRAT = 0x84D,
    PDP_FAIL_DS_EXPLICIT_DEACT = 0x84E,
    PDP_FAIL_ESM_LOCAL_CAUSE_NONE = 0x84F,
    PDP_FAIL_LTE_NAS_SERVICE_REQ_FAILED_NO_THROTTLE = 0x850,
    PDP_FAIL_ACCESS_CONTROL_LIST_CHECK_FAILURE = 0x851,
    PDP_FAIL_LTE_NAS_SERVICE_REQ_FAILED_DS_DISALLOW = 0x852,
    PDP_FAIL_EMM_T3417_EXPIRED = 0x853,
    PDP_FAIL_EMM_T3417_EXT_EXPIRED = 0x854,
    PDP_FAIL_LRRC_UL_DATA_CNF_FAILURE_TXN = 0x855,
    PDP_FAIL_LRRC_UL_DATA_CNF_FAILURE_HO = 0x856,
    PDP_FAIL_LRRC_UL_DATA_CNF_FAILURE_CONN_REL = 0x857,
    PDP_FAIL_LRRC_UL_DATA_CNF_FAILURE_RLF = 0x858,
    PDP_FAIL_LRRC_UL_DATA_CNF_FAILURE_CTRL_NOT_CONN = 0x859,
    PDP_FAIL_LRRC_CONN_EST_FAILURE = 0x85A,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_ABORTED = 0x85B,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_ACCESS_BARRED = 0x85C,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_CELL_RESEL = 0x85D,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_CONFIG_FAILURE = 0x85E,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_TIMER_EXPIRED = 0x85F,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_LINK_FAILURE = 0x860,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_NOT_CAMPED = 0x861,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_SI_FAILURE = 0x862,
    PDP_FAIL_LRRC_CONN_EST_FAILURE_CONN_REJECT = 0x863,
    PDP_FAIL_LRRC_CONN_REL_NORMAL = 0x864,
    PDP_FAIL_LRRC_CONN_REL_RLF = 0x865,
    PDP_FAIL_LRRC_CONN_REL_CRE_FAILURE = 0x866,
    PDP_FAIL_LRRC_CONN_REL_OOS_DURING_CRE = 0x867,
    PDP_FAIL_LRRC_CONN_REL_ABORTED = 0x868,
    PDP_FAIL_LRRC_CONN_REL_SIB_READ_ERROR = 0x869,
    PDP_FAIL_DETACH_WITH_REATTACH_LTE_NW_DETACH = 0x86A,
    PDP_FAIL_DETACH_WITHOUT_REATTACH_LTE_NW_DETACH = 0x86B,
    PDP_FAIL_ESM_PROC_TIME_OUT = 0x86C,
    PDP_FAIL_INVALID_CONNECTION_ID = 0x86D,
    PDP_FAIL_INVALID_NSAPI = 0x86E,
    PDP_FAIL_INVALID_PRI_NSAPI = 0x86F,
    PDP_FAIL_INVALID_FIELD = 0x870,
    PDP_FAIL_RAB_SETUP_FAILURE = 0x871,
    PDP_FAIL_PDP_ESTABLISH_MAX_TIMEOUT = 0x872,
    PDP_FAIL_PDP_MODIFY_MAX_TIMEOUT = 0x873,
    PDP_FAIL_PDP_INACTIVE_MAX_TIMEOUT = 0x874,
    PDP_FAIL_PDP_LOWERLAYER_ERROR = 0x875,
    PDP_FAIL_PDP_MODIFY_COLLISION = 0x876,
    PDP_FAIL_SM_NO_RADIO_AVAILABLE = 0x877,
    PDP_FAIL_SM_ABORT_SERVICE_NOT_AVAILABLE = 0x878,
    PDP_FAIL_MESSAGE_EXCEED_MAX_L2_LIMIT = 0x879,
    PDP_FAIL_SM_NAS_SRV_REQ_FAILURE = 0x87A,
    PDP_FAIL_RRC_CONN_EST_FAILURE_REQ_ERROR = 0x87B,
    PDP_FAIL_RRC_CONN_EST_FAILURE_TAI_CHANGE = 0x87C,
    PDP_FAIL_RRC_CONN_EST_FAILURE_RF_UNAVAILABLE = 0x87D,
    PDP_FAIL_RRC_CONN_REL_ABORTED_IRAT_SUCCESS = 0x87E,
    PDP_FAIL_RRC_CONN_REL_RLF_SEC_NOT_ACTIVE = 0x87F,
    PDP_FAIL_RRC_CONN_REL_IRAT_TO_LTE_ABORTED = 0x880,
    PDP_FAIL_RRC_CONN_REL_IRAT_FROM_LTE_TO_G_CCO_SUCCESS = 0x881,
    PDP_FAIL_RRC_CONN_REL_IRAT_FROM_LTE_TO_G_CCO_ABORTED = 0x882,
    PDP_FAIL_IMSI_UNKNOWN_IN_HSS = 0x883,
    PDP_FAIL_IMEI_NOT_ACCEPTED = 0x884,
    PDP_FAIL_EPS_SERVICES_AND_NON_EPS_SERVICES_NOT_ALLOWED = 0x885,
    PDP_FAIL_EPS_SERVICES_NOT_ALLOWED_IN_PLMN = 0x886,
    PDP_FAIL_MSC_TEMPORARILY_NOT_REACHABLE = 0x887,
    PDP_FAIL_CS_DOMAIN_NOT_AVAILABLE = 0x888,
    PDP_FAIL_ESM_FAILURE = 0x889,
    PDP_FAIL_MAC_FAILURE = 0x88A,
    PDP_FAIL_SYNCH_FAILURE = 0x88B,
    PDP_FAIL_UE_SECURITY_CAPABILITIES_MISMATCH = 0x88C,
    PDP_FAIL_SECURITY_MODE_REJ_UNSPECIFIED = 0x88D,
    PDP_FAIL_NON_EPS_AUTH_UNACCEPTABLE = 0x88E,
    PDP_FAIL_CS_FALLBACK_CALL_EST_NOT_ALLOWED = 0x88F,
    PDP_FAIL_NO_EPS_BEARER_CONTEXT_ACTIVATED = 0x890,
    PDP_FAIL_EMM_INVALID_STATE = 0x891,
    PDP_FAIL_NAS_LAYER_FAILURE = 0x892,
    PDP_FAIL_MULTI_PDN_NOT_ALLOWED = 0x893,
    PDP_FAIL_EMBMS_NOT_ENABLED = 0x894,
    PDP_FAIL_PENDING_REDIAL_CALL_CLEANUP = 0x895,
    PDP_FAIL_EMBMS_REGULAR_DEACTIVATION = 0x896,
    PDP_FAIL_TLB_REGULAR_DEACTIVATION = 0x897,
    PDP_FAIL_LOWER_LAYER_REGISTRATION_FAILURE = 0x898,
    PDP_FAIL_DETACH_EPS_SERVICES_NOT_ALLOWED = 0x899,
    PDP_FAIL_SM_INTERNAL_PDP_DEACTIVATION = 0x89A,
    PDP_FAIL_CD_GEN_OR_BUSY = 0x89B,
    PDP_FAIL_CD_BILL_OR_AUTH = 0x89C,
    PDP_FAIL_HDR_CHANGED = 0x89D,
    PDP_FAIL_HDR_EXITED = 0x89E,
    PDP_FAIL_HDR_NO_SESSION = 0x89F,
    PDP_FAIL_HDR_ORIG_DURING_GPS_FIX = 0x8A0,
    PDP_FAIL_HDR_CS_TIMEOUT = 0x8A1,
    PDP_FAIL_COLLOC_ACQ_FAIL = 0x8A2,
    PDP_FAIL_OTASP_COMMIT_IN_PROG = 0x8A3,
    PDP_FAIL_NO_HYBR_HDR_SRV = 0x8A4,
    PDP_FAIL_HDR_NO_LOCK_GRANTED = 0x8A5,
    PDP_FAIL_HOLD_OTHER_IN_PROG = 0x8A6,
    PDP_FAIL_HDR_FADE = 0x8A7,
    PDP_FAIL_HDR_ACC_FAIL = 0x8A8,
    PDP_FAIL_UNSUPPORTED_1X_PREV = 0x8A9,
    PDP_FAIL_LOCAL_END = 0x8AA,
    PDP_FAIL_NO_SRV = 0x8AB,
    PDP_FAIL_FADE = 0x8AC,
    PDP_FAIL_REL_NORMAL = 0x8AD,
    PDP_FAIL_ACC_IN_PROG = 0x8AE,
    PDP_FAIL_ACC_FAIL = 0x8AF,
    PDP_FAIL_REDIR_OR_HANDOFF = 0x8B0,
    PDP_FAIL_EMERGENCY_MODE = 0x8B1,
    PDP_FAIL_PHONE_IN_USE = 0x8B2,
    PDP_FAIL_INVALID_MODE = 0x8B3,
    PDP_FAIL_INVALID_SIM_STATE = 0x8B4,
    PDP_FAIL_NO_COLLOC_HDR = 0x8B5,
    PDP_FAIL_EMM_DETACHED_PSM = 0x8B6,
    PDP_FAIL_DUAL_SWITCH = 0x8B7,
    PDP_FAIL_PPP_TIMEOUT = 0x8B8,
    PDP_FAIL_PPP_AUTH_FAILURE = 0x8B9,
    PDP_FAIL_PPP_OPTION_MISMATCH = 0x8BA,
    PDP_FAIL_PPP_PAP_FAILURE = 0x8BB,
    PDP_FAIL_PPP_CHAP_FAILURE = 0x8BC,
    PDP_FAIL_PPP_ERR_CLOSE_IN_PROGRESS = 0x8BD,
    PDP_FAIL_EHRPD_SUBS_LIMITED_TO_V4 = 0x8BE,
    PDP_FAIL_EHRPD_SUBS_LIMITED_TO_V6 = 0x8BF,
    PDP_FAIL_EHRPD_VSNCP_TIMEOUT = 0x8C0,
    PDP_FAIL_EHRPD_VSNCP_GEN_ERROR = 0x8C1,
    PDP_FAIL_EHRPD_VSNCP_UNAUTH_APN = 0x8C2,
    PDP_FAIL_EHRPD_VSNCP_PDN_LIMIT_EXCEED = 0x8C3,
    PDP_FAIL_EHRPD_VSNCP_NO_PDN_GW = 0x8C4,
    PDP_FAIL_EHRPD_VSNCP_PDN_GW_UNREACH = 0x8C5,
    PDP_FAIL_EHRPD_VSNCP_PDN_GW_REJ = 0x8C6,
    PDP_FAIL_EHRPD_VSNCP_INSUFF_PARAM = 0x8C7,
    PDP_FAIL_EHRPD_VSNCP_RESOURCE_UNAVAIL = 0x8C8,
    PDP_FAIL_EHRPD_VSNCP_ADMIN_PROHIBIT = 0x8C9,
    PDP_FAIL_EHRPD_VSNCP_PDN_ID_IN_USE = 0x8CA,
    PDP_FAIL_EHRPD_VSNCP_SUBSCR_LIMITATION = 0x8CB,
    PDP_FAIL_EHRPD_VSNCP_PDN_EXISTS_FOR_THIS_APN = 0x8CC,
    PDP_FAIL_EHRPD_VSNCP_RECONNECT_NOT_ALLOWED = 0x8CD,
    PDP_FAIL_IPV6_PREFIX_UNAVAILABLE = 0x8CE,
    PDP_FAIL_HANDOFF_PREF_SYS_BACK_TO_SRAT = 0x8CF,
