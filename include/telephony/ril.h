 ...
 * RIL_VERSION = 16 : New data structure RIL_DataRegistrationStateResponse,
 ...
 */
typedef enum {
    RIL_NOT_REG_AND_NOT_SEARCHING,           // Not registered, MT is not currently searching
                                             // a new operator to register
    RIL_REG_HOME,                            // Registered, home network
    RIL_NOT_REG_AND_SEARCHING,               // Not registered, but MT is currently searching
                                             // a new operator to register
    RIL_REG_DENIED,                          // Registration denied
    RIL_UNKNOWN,                             // Unknown
    RIL_REG_ROAMING,                         // Registered, roaming
    RIL_NOT_REG_AND_EMERGENCY_AVAILABLE_AND_NOT_SEARCHING,   // Same as
                                             // RIL_NOT_REG_AND_NOT_SEARCHING but indicates that
                                             // emergency calls are enabled.
    RIL_NOT_REG_AND_EMERGENCY_AVAILABLE_AND_SEARCHING,  // Same as RIL_NOT_REG_AND_SEARCHING
                                             // but indicates that
                                             // emergency calls are enabled.
    RIL_REG_DENIED_AND_EMERGENCY_AVAILABLE,  // Same as REG_DENIED but indicates that
                                             // emergency calls are enabled.
    RIL_UNKNOWN_AND_EMERGENCY_AVAILABLE,     // Same as UNKNOWN but indicates that
                                             // emergency calls are enabled.
} RIL_RegState;
